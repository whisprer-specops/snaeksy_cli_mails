...
.EXAMPLE
    .\wofl_obs-descrypt-v-0-1-0.ps1 -Mode Encrypt -Path "C:\path\to\file.txt"
    
.EXAMPLE
    .\wofl_obs-descrypt-v-0-1-0.ps1 -Mode Encrypt -Path "C:\path\to\folder" -Recursive -OutputPath "C:\encrypted"
    
.EXAMPLE
    .\wofl_obs-descrypt-v-0-1-0.ps1 -Mode Decrypt -Path "C:\path\to\file.enc.xml" -OutputPath "C:\decrypted\file.txt"
    
.EXAMPLE
    .\wofl_obs-descrypt-v-0-1-0.ps1 -Mode ListEncrypted -Path "C:\encrypted"

.EXAMPLE
    .\wofl_obs-descrypt-v-0-1-0.ps1 -Mode Encrypt -Path "C:\secret_files" -Recursive -SecureDelete -ShredPasses 7
    # Encrypts all files and securely wipes originals with 7 passes
    
.EXAMPLE
    .\wofl_obs-descrypt-v-0-1-0.ps1 -Mode Encrypt -Path "C:\secret_files" -Recursive -SecureDelete -CleanEmptyFolders
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURulCgTZFgw3KAYvgS8dWP9hj
# WxqgggMIMIIDBDCCAeygAwIBAgIQc50Mze914pZL6X2yfSdiJTANBgkqhkiG9w0B
# AQsFADAaMRgwFgYDVQQDDA9UZXN0Q29kZVNpZ25pbmcwHhcNMjUwNTExMDQwNjAy
# WhcNMjYwNTExMDQyNjAyWjAaMRgwFgYDVQQDDA9UZXN0Q29kZVNpZ25pbmcwggEi
# MA0GCSqGSIb3DQEBAQUAA4IBDwAwggEKAoIBAQDN+od5eDqhu2FU+Gp6XQFFyRQi
# oDLg/qoc7RSgR80E3FrCRyo1kY+A8kHcFwoY3Gf5YqnXvUD1H4I8uZBeXnrn2hIF
# 1XDf8C0GMuFficqoUdcR3ENaMElQO7eu0MfXqSVzcsiGp5nLZ26MjAlysxzrq7Ac
# ASlacWmNhkMY7ba9Mw+bHOniXq1lTwHaqN0uz/Xwtq//HkTk35vBfK9XnAsZaxtL
# HCSlYWjzquYXKkRJ39JBSJUmljHM7kZ9N+G7OR8xhIpdfDeBETG4mF8HWWNUKfR+
# uDCyCol8Fg+ITactDzh3k6p8nyRRNfUJ+vRAnadfiYYcbySL+mr3HaisgFbtAgMB
# AAGjRjBEMA4GA1UdDwEB/wQEAwIHgDATBgNVHSUEDDAKBggrBgEFBQcDAzAdBgNV
# HQ4EFgQU9U4Stj942ERzg7Hon500Aj7vgg8wDQYJKoZIhvcNAQELBQADggEBALQQ
# 1HYulOZ5Y01bmywtReWIMV4w9aYWxXHk7qkJNF0I6n4U6WL4aH3vgLGEFwZxifAX
# +LDQwDEcQ8iBofrJxAxvM5Ik9GwauPO74ZTiLqvLTHWrUeJoiwyUSRrBy1A1bM7O
# l8zwI88eF5o9ji3JA+nYp38wDf/uSypT7jsAkZrTtaDTA5sxZIGTr6gBUGcmcixU
# E3ZgF+UeuiXB6gngoslP/+Sv1kL11lHIpF9ADXJFOKBiqNwfl9Q8XGqMN17qZeD/
# kNOPQoVkK2jW/mICI62N+BBrtYjKc3U01sVB1QecJukHmtjls5E2Ea2X8nietl6F
# y5itXEp18r0bTjtsU4IxggHPMIIBywIBATAuMBoxGDAWBgNVBAMMD1Rlc3RDb2Rl
# U2lnbmluZwIQc50Mze914pZL6X2yfSdiJTAJBgUrDgMCGgUAoHgwGAYKKwYBBAGC
# NwIBDDEKMAigAoAAoQKAADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAcBgor
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUohtPrGQ1
# S0Sy4G4N8HzqnD7+j7UwDQYJKoZIhvcNAQEBBQAEggEAd9gjcfp7PJkboQkYjVod
# H9tkXWAZcs4BNsGsmX2WGiIYh2M1C4/VoEyswMiFmW0uJOfCCrSqfP6bwJPsovQn
# DiXmPJVuiRR+VO4yY8yxqlTReMFdUvrjBGwjxU4/VuAhRhGwvU+Vt/YevEtd4sP1
# /6qMmV/jw3p4f8f2rqUvQgR/aLz3YgC5qaK2g38zXOjPi6R2JR3giozs+uDwP6Sk
# wiOOGoITsPDOxEvmb1IGrOaSxlU2DRS3AlMeUfxjlBN8DVASxdLXBtl6TX5z72Ch
# uNwj/vOi+ORtAUSDP7ouBTbXDWDuEpjLg+SyupfFnQOjGprLwh9GBNCL9F4UbYM0
# iw==
