...
function Confirm-SecureDeletion {
    ...
    $message = "WARNING: You are about to SECURELY DELETE the original $descriptor after processing.`nThis operation CANNOT be undone!`n`nAre you sure you want to proceed? (Y/N): "
